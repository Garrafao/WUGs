...
- Emma Sköldberg, Shafqat Mumtaz Virk, Pauline Sander, Simon Hengchen, Dominik Schlechtweg. 2024. [Revealing semantic variation in Swedish using computational models of semantic proximity: Results from lexicographical experiments](https://euralex.jezik.hr/proceedings/). Proceedings of the 21st EURALEX International Congress Lexicography and Semantics.
