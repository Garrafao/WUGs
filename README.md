...
- Emma Sköldberg, Shafqat Mumtaz Virk, Pauline Sander, Simon Hengchen, Dominik Schlechtweg. 2024. [Revealing semantic variation in Swedish using computational models of semantic proximity: Results from lexicographical experiments](https://euralex.org/publications/revealing-semantic-variation-in-swedish-using-computational-models-of-semantic-proximity-results-from-lexicographical-experiments/). Proceedings of the 21st EURALEX International Congress Lexicography and Semantics.
- Pauline Sander, Simon Hengchen, Wei Zhao, Xiaocheng Ma, Emma Sköldberg, Shafqat Mumtaz Virk, Dominik Schlechtweg. 2024. [The DURel Annotation Tool: Using fine-tuned LLMs to discover non-recorded senses in multiple languages](https://www.cjvt.si/wp-content/uploads/2024/10/LLM-Lex_2024_Book-of-Abstracts.pdf). Proceedings of the Workshop on Large Language Models and Lexicography at 21st EURALEX International Congress Lexicography and Semantics.
- Dominik Schlechtweg, Pierluigi Cassotti, Bill Noble, David Alfter, Sabine Schulte im Walde, Nina Tahmasebi. 2024. [More DWUGs: Extending and Evaluating Word Usage Graph Datasets in Multiple Languages](https://aclanthology.org/2024.emnlp-main.796/). Proceedings of the 2024 Conference on Empirical Methods in Natural Language Processing.
