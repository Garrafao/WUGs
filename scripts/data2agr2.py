...
[_, annotation, modus, min_, max_, scale, non_value, annotators, excluded, output_file] = sys.argv
...
if not scale == 'ordinal':
    print('Warning: Skipping agreement calculation: Non-ordinal scales not implemented.')
    sys.exit(0)   
